...
<div class="mt-32 px-5 grid gap-20">
    <div class="container mx-auto md:max-w-3xl">
        <div class="text-slate-700 leading-relaxed grid md:grid-cols-4 gap-12 md:gap-6 dark:text-slate-200">
            <div class="relative md:col-span-1 md:order-last">
                <img src="{profile}" class="relative z-10 w-32 md:w-36 md:mx-auto top-0 border-4 border-white dark:border-slate-900 shadow-md shadow-slate-900/10 dark:shadow-slate-950/20 rounded-lg" alt="">
                <div class="p-4 md:pt-20 md:-mt-20 rounded-lg bg-slate-50 dark:bg-slate-800">
                    <div class="mt-4 flex flex-col content-center">
                        <a class="group text-slate-700/80 hover:text-slate-900 dark:text-slate-200 items-center justify-between rounded-md transition-all px-2 py-1 flex hover:bg-slate-900/10 dark:hover:bg-slate-700" href="">
                            Email
