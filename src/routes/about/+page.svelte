    ...
    <div class="container mx-auto md:max-w-3xl">
        <div class="text-slate-700 leading-relaxed grid md:grid-cols-4 gap-12 md:gap-6 dark:text-slate-200">
            <div class="relative md:col-span-1 order-last">
                <img src="{profile}" class="absolute md:relative z-10 w-24 md:w-36 md:mx-auto right-4 md:right-0 top-4 md:top-0 border-4 border-white dark:border-slate-900 shadow-md shadow-slate-900/10 dark:shadow-slate-950/20 rounded-lg" alt="">
            ...
            <div class="grid gap-3 md:col-span-3">
                ...
                <div class="hidden gap-3 mt-2">
                    ...
                    <div class="grid gap-4 md:flex items-center">
                        ...
                        <a class={linkStyles} href="">Resume</a>
                        <a class={linkStyles} href="">LinkedIn</a>
                    </div>
                </div>
            </div>
        </div>
